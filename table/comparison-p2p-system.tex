\begin{table}[h]
	...
	\hline
		...
		\multicolumn{1}{ c|}{\rotatebox{90}{Пропускная способность }}&
		\multicolumn{1}{ c|}{\rotatebox{90}{Низкие задержки}}&
		\multicolumn{1}{ c|}{\rotatebox{90}{Надёжность}}&
		\multicolumn{1}{ c|}{\rotatebox{90}{Масштабируемость}}&
